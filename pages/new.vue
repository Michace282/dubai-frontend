    ...
    export default {
        ...
        data() {
            ...
            return {
                ...
                loading: true,
                h1: '',
                title: 'Dance catalogue costumes. Dance outfits for practice|',
                description: 'Massive collection of dancewear, any dancing stuff you need for your successful dance session, event or competition you can find with us.',
                keywords: 'Dance costumes, Dance outfit'
            };
        },
        head() {
            return {
        ...
        methods: {
            changeFilter(f) {
                ...
                if(f.productType == "mens_dancewear") {
                    this.filter = {...f, productType: 'mens'}
                    return;
                }
                if(f.productType == "womens_dancewear") {
                    this.filter = {...f, productType: 'ladies'}
                    return;
                }

                if (f.danceShoesType) {
                    if(f.danceShoesType == 'mens_shoes') {
                        this.filter = {...f, danceShoesType: 'mens'}
                    } else if(f.danceShoesType == 'womens_shoes') {
                        this.filter = {...f, danceShoesType: 'ladies'}
                    }
                } else {
                    this.filter = f;
                }
